...
var s1 = new Student('Chính', 8, 0, [{ title: 'toán', mark: 6 }, { title: 'lý', mark: 7 }])
var s2 = new Student('Thọ', 6, 0, [{ title: 'toán', mark: 0 }, { title: 'lý', mark: 5 }])
var s3 = new Student('Nhi', 4.5, 1, [{ tiile: 'toán', mark: 4 }, { title: 'lý', mark: 5 }])
var s4 = new Student('Quân', 9, 0, [{ title: 'toán', mark: 8 }, { title: 'lý', mark: 9 }])
var s5 = new Student('Nhung', 8.5, 1, [{ title: 'toán', mark: 8 }, { title: 'lý', mark: 8 }])
var s6 = new Student('Tiến', 9, 0, [{ title: 'toán', mark: 9.5 }, { title: 'lý', mark: 7 }])
var s7 = new Student('Yến', 6, 1, [{ title: 'toán', mark: 4 }, { title: 'lý', mark: 3 }])
var s8 = new Student('Triều', 03, 0, [{ title: 'toán', mark: 3 }, { title: 'lý', mark: 1 }])
var s9 = new Student('Vinh', 5, 0, [{ title: 'toán', mark: 7 }, { title: 'lý', mark: 2 }])
var s10 = new Student('Ngọc', 1, 1, [{ title: 'toán', mark: 2 }, { title: 'lý', mark: 1 }])
...
var s11 = new Student('TT', 5, 0, [{ title: 'toán', mark: 6 }, { title: 'lý', mark: 6 }])
var s12 = new Student('VV', 6, 0, [{ title: 'toán', mark: 7 }, { title: 'lý', mark: 5 }])
var s13 = new Student('HH', 7, 0, [{ title: 'toán', mark: 8 }, { title: 'lý', mark: 8 }])
